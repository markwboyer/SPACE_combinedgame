...
namespace RosMessageTypes.Msgs
{
    ...
    {
        public const string k_RosMessageName = "msgs/JointLimits";
        ...
        public JointLimitsMsg(string joint_name, bool has_position_limits, double min_position, double max_position, bool has_velocity_limits, double max_velocity, bool has_acceleration_limits, double max_acceleration, bool has_jerk_limits, double max_jerk)
        {
        ...
        private JointLimitsMsg(MessageDeserializer deserializer)
        {
            ...
            deserializer.Read(out this.has_jerk_limits);
            deserializer.Read(out this.max_jerk);
        }
        ...
        public override void SerializeTo(MessageSerializer serializer)
        {
            ...
            serializer.Write(this.has_jerk_limits);
            serializer.Write(this.max_jerk);
        }
        ...
        public override string ToString()
        {
            ...
            "\nhas_jerk_limits: " + has_jerk_limits.ToString() +
            "\nmax_jerk: " + max_jerk.ToString();
        }
