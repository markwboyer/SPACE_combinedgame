...
namespace RosMessageTypes.Msgs
{
    ...
    {
        public const string k_RosMessageName = "msgs/GenericTrajectory";
        ...
        public Moveit.CartesianTrajectoryMsg[] cartesian_trajectory;

        public GenericTrajectoryMsg()
        {
            this.header = new Std.HeaderMsg();
            this.joint_trajectory = new Trajectory.JointTrajectoryMsg[0];
            this.cartesian_trajectory = new Moveit.CartesianTrajectoryMsg[0];
        }

        public GenericTrajectoryMsg(Std.HeaderMsg header, Trajectory.JointTrajectoryMsg[] joint_trajectory, Moveit.CartesianTrajectoryMsg[] cartesian_trajectory)
        {
            this.header = header;
        ...
        private GenericTrajectoryMsg(MessageDeserializer deserializer)
        {
            ...
            deserializer.Read(out this.cartesian_trajectory, Moveit.CartesianTrajectoryMsg.Deserialize, deserializer.ReadLength());
        }
