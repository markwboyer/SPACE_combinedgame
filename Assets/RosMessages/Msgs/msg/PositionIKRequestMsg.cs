...
namespace RosMessageTypes.Msgs
{
    ...
    {
        public const string k_RosMessageName = "msgs/PositionIKRequest";
        ...
        public Moveit.RobotStateMsg robot_state;
        ...
        {
            this.group_name = "";
            this.robot_state = new Moveit.RobotStateMsg();
        ...
        public PositionIKRequestMsg(string group_name, Moveit.RobotStateMsg robot_state, ConstraintsMsg constraints, bool avoid_collisions, string ik_link_name, Geometry.PoseStampedMsg pose_stamped, string[] ik_link_names, Geometry.PoseStampedMsg[] pose_stamped_vector, BuiltinInterfaces.DurationMsg timeout)
        {
        ...
        private PositionIKRequestMsg(MessageDeserializer deserializer)
        {
            ...
            this.robot_state = Moveit.RobotStateMsg.Deserialize(deserializer);
